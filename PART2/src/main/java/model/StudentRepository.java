package model;//package com.example.demo3;
...
public class StudentRepository implements RepositoryInterface {
    ...
    public static synchronized StudentRepository getInstance(String username, String password) throws SQLException {
        if (instance == null) {
            instance = new StudentRepository(username, password);
        }
        return instance;
    }
...
//                    System.out.println("welcome " + studentName);
    ...
    public  String getCourseInformation(int course_id) throws SQLException, ClassNotFoundException {
        ...
        String message="";
        ResultSet resultSet=statement.executeQuery("SELECT course_name FROM  courses WHERE course_id ="+course_id);
        resultSet.next();
        message+="course : "+resultSet.getString(1)+"\n";
